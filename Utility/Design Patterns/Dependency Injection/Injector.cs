    ...
    public class Injector : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            IEnumerable<IDependencyProvider> providers
                = monoBehaviours.Where(obj => obj is IDependencyProvider).Select(obj => obj.GetComponent<IDependencyProvider>());
        ...
        {
            MonoBehaviour[] monoBehaviours = FindMonoBehaviours();
            IEnumerable<IDependencyProvider> providers = monoBehaviours
                                                         .Where(x=>x is IDependencyProvider)
                                                         .Select(x=> (IDependencyProvider)x);
