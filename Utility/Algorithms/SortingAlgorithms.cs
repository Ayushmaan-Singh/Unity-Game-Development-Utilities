...
namespace AstekUtility
{
	public static class SortingAlgorithms
	{
		...
		public static void QuickSort<T>(this IEnumerable<T> collection, Comparison<T> comparison)
		{
		...
		public static void MergeSort<T>(this IEnumerable<T> collection, Comparison<T> comparison)
		{
			List<T> list = collection.ToList();
